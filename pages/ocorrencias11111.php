...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($erros)) {
        ...
        $sql = "INSERT INTO ocorrencias (tipo, etapa_processo, estudante_mat, status_de_conclusao, responsavel_ocor_cpf, servidor_responsavel, descricao, infracao_artigo)
                VALUES ('$tipo', '$etapa_processo', '$estudante_mat', '$status_de_conclusao', '$responsavel_ocor_cpf', '$servidor_responsavel', '$descricao', '$infracao_artigo')";
